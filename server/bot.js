  ...
  switch (data) {
    case 'catalog':
      bot.sendMessage(chatId, 
        ...
        `🇯🇵 Япония - от $12\n` +
        `🇦🇪 ОАЭ - от $15\n\n` +
        `Нажми "🌊 Открыть eWave" чтобы увидеть все тарифы!`,
    ...
    case 'prices':
      bot.sendMessage(chatId,
        `💰 *Цены на eSIM*\n\n` +
        `Цены зависят от страны и объёма данных:\n\n` +
        `📊 *Примеры тарифов:*\n` +
        `• 1 GB / 7 дней - от $5\n` +
        `• 5 GB / 30 дней - от $15\n` +
        `• 10 GB / 30 дней - от $25\n` +
        `• Безлимит / 30 дней - от $50\n\n` +
        `*Преимущества:*\n` +
        `✅ Без скрытых платежей\n` +
        `✅ Без абонентской платы\n` +
        `✅ Выгоднее роуминга в 10 раз!\n\n` +
        `Открой приложение чтобы увидеть точные цены! 👇`,
        { parse_mode: 'Markdown', ...mainMenu }
      );
      break;
    ...
    case 'orders':
      bot.sendMessage(chatId,
        ...
        `открой приложение и перейди в раздел "Мои заказы".\n\n` +
        `Там ты найдёшь:\n` +
        `• Все купленные eSIM\n` +
        `• QR-коды для повторной установки\n` +
        `• Статус активации\n` +
        `• Остаток трафика\n\n` +
        `*Потерял QR-код?*\n` +
        `Не волнуйся! Все коды сохранены в приложении.`,
        { parse_mode: 'Markdown', ...mainMenu }
      );
      break;
