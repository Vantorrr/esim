...
class EsimGoAPI {
  ...
  async getRegionPackages(regionSlug) {
    ...
    const regionPatterns = {
      ...
      'global-max': { pattern: /global.*max/i, longTerm: false },
      'europe-usa': { pattern: /europe.*usa|europe.*us[^a-z]/i, longTerm: false },
      'south-east-europe': { pattern: /south.*east.*europe/i, longTerm: false },
