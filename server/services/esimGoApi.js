...
class EsimGoAPI {
  ...
  getRegionalCategories(packages) {
    ...
    // ВСЕ регионы показывают только долгосрочные пакеты (60, 90, 180 дней)
    const regions = [
      { order: 1,  name: 'Global - Light',        nameRu: 'Весь мир – Лайт',        pattern: /global.*light/i,     icon: '🌍', longTerm: true },
      { order: 2,  name: 'Global - Standard',     nameRu: 'Весь мир – Стандарт',     pattern: /global.*standard/i,  icon: '🌍', longTerm: true },
      { order: 3,  name: 'Global - Max',          nameRu: 'Весь мир – Макс',         pattern: /global.*max/i,       icon: '🌍', longTerm: true },
      { order: 4,  name: 'Europe + USA',          nameRu: 'Европа + США',           pattern: /europe.*usa|europe.*us[^a-z]/i, icon: '🇪🇺', longTerm: true },
      { order: 5,  name: 'Middle East',           nameRu: 'Ближний Восток',          pattern: /middle.*east/i,      icon: '🕌', longTerm: true },
      { order: 6,  name: 'Asia',                  nameRu: 'Азия',                    pattern: /asia/i,              icon: '🌏', longTerm: true },
      { order: 7,  name: 'Americas',              nameRu: 'Америка',                 pattern: /americas/i,          icon: '🌎', longTerm: true },
      { order: 8,  name: 'Africa',                nameRu: 'Африка',                  pattern: /africa/i,            icon: '🌍', longTerm: true },
      { order: 9,  name: 'Europe + Business Hubs',nameRu: 'Европа + Деловые центры', pattern: /europe.*business|business.*hub/i, icon: '🇪🇺', longTerm: true },
      { order: 10, name: 'South East Europe',     nameRu: 'Юго-Восточная Европа',    pattern: /south.*east.*europe/i, icon: '🇪🇺', longTerm: true },
    ];
  ...
  async getRegionPackages(regionSlug) {
    ...
    // Маппинг slug → паттерн для поиска (ВСЕ регионы - только долгосрочные пакеты)
